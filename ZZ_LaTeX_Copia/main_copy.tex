...
\begin{landscape}
	\vspace*{\fill}
	\begin{center}
		\includegraphics[width=\linewidth,height=0.76\textheight,keepaspectratio]{IPCI.png}
		\captionof{figure}{Clasificación conceptual y esquema tipológico de las instalaciones de protección activa contra incendios contempladas en el proyecto. Fuente: Elaboración grupal.}
		\label{fig:ipci}
	\end{center}
	\vspace*{\fill}
\end{landscape}
